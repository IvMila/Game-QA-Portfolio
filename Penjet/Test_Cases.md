...
[14\. Поява UI поразки/перемоги](#14-поява-ui-поразкиперемоги)
...
[15\. Поведінка при втраті інтернет-з’єднання під час рівня](#15-поведінка-при-втраті-інтернет-зєднання-під-час-рівня)
...
## 05\. Механіка “tap” на ноту під час гри 
...
## 06\. Механіка “hold” ноту під час гри 
...
## 07\. Механіка “slide” в певному напрямку ноту
...
## 08\. Прогрес бар тривалості рівня
...
## 09\. Проходження рівня при активній взаємодії
...
## 10\. Проходження рівня без взаємодії
...
## 13\. Збереження статистики гравця після рівня 
...
## 16\. Продовження рівня після натискання “Пауза” 
...
## 17\. Вихід із рівня через меню паузи 
...
## 03\. Оновлення UI кількості монет після проходження рівня (перемога)
...
## 04\. Оновлення UI кількості монет після без взаємодії з рівнем
...
## 19\. Візуальна реакція на “ідеальне” натискання 
...
# Test Suite 3\. Економіка та баланс.

## 01.Купити аватар при достатній кількості монет 
...
## 02\. Купівля аватару при відсутності достатньої кількості монет
...
## 20\. Отримання монет після перемоги 
...
# Test Suite 4\. Аудіо та звук. 

## 21\. Синхронізація звуку з нотами 
...
## 22\. Гра при вимкненому звуці на пристрої 
...
## 23\. Відсутність звуку при паузі 
...
## 15\. Поведінка при втраті інтернет-з’єднання під час рівня 
...
## 24\. Вхідний дзвінок під час гри 
...
## 25\. Вихід у головне меню системи (Home) 
...
## 26\. Перехід у режим сну (вимкнути екран) 
