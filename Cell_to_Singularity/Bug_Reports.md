...
- [**02\. Текст “Прокаріотична клітина” перекриває левел “ДНК”**](#02-теекст-прокаріотична-клітина-перекривває-левел-днк)
...
- [**05\. Баланс збільшується після переривання перегляду реклами “Подвоїти це”**](#05-баланс-збільшується-післ-переривання-перегляду-реклами-подвоїти-це)
- [**06\. Кількість “Ентропії” зменшився після звичайного тестування**](#06-ккількість-ентропії-змееншилася-після-звичайного-тестування)
- [**07\. Вікно “Офлайн заробіток” не з’явилося після розриву перегляду реклами**](#07-вікно-офлайн-зоробіток-не-зявилося-після-розриву-перегляду-реклами)
